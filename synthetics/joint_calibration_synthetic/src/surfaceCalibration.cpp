...
public:
    ...
    surfaceCalibration(vector<double> K, vector<double> T, vector<vector<double>> grid, vector<double> guesses, QuantLib::Date today, double spot, double r, double q){
        ...
        K_ = K; T_ = T; grid_ = grid; today_ = today; spot_ = spot; r_ = r; q_ = q;
